...
bool knapp_amr__msg__order__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("knapp_amr.msg._order.Order", full_classname_dest, 26) == 0);
  }
  knapp_amr__msg__Order * ros_message = _ros_message;
  {  // order_id
...
PyObject * knapp_amr__msg__order__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("knapp_amr.msg._order");
